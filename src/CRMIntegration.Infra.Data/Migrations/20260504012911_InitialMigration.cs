        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalLidos = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTelefoneCobMais = table.Column<int>(type: "integer", nullable: true),
                    Acionavel = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataFalha = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CampaignMessages_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignMessages_CampaignId_ClientId",
                table: "CampaignMessages",
                columns: new[] { "CampaignId", "ClientId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CampaignMessages_ClientId",
                table: "CampaignMessages",
                column: "ClientId");
